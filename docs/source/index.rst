...
The `ggnn library <https://github.com/cgtuebingen/ggnn>`_ provides an efficient algorithm for approximate nearest neighbor (ANN) search that takes advatage of the massive parallelism offered by GPUs. 
